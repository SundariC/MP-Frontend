    ...
    <div className="pt-28 pb-20 px-6 max-w-7xl mx-auto bg-[#F8FAFC] min-h-screen">
      <div className="mb-12 text-center">
        ...
        <p className="text-slate-500 mb-8">
          Search from our curated list of professional licensed counselors.
        </p>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredCounselors.length > 0 ? (
          filteredCounselors.map((doc) => (
            <div
              key={doc._id}
              className="bg-white p-8 rounded-[2.5rem] border border-slate-50 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group"
            >
              ...
              <p className="text-teal-600 font-bold text-sm mb-4 bg-teal-50 inline-block px-3 py-1 rounded-lg">
                {doc.specialization}
              </p>
                    ...
                    navigate("/checkoutPage", {
                      state: {
                        counselor: {
                          ...
                          clients: doc.clients || 200,
                        },
                      },
                    })
                  }
                  className="px-8 py-4 bg-teal-600 text-white rounded-2xl font-bold text-sm"
                >
                  Book Now
                </button>
              </div>
